    ...
    <div class="thumbnail img-rounded">
      ...
      <div class="caption">
        ...
        <p>
          ...
          <a href="#" class="btn btn-primary" role="button"><span class="fa fa-eye" aria-hidden="true"></span></a>
          <?php if ($_SESSION['user']['username'] == $image->owner): ?>
            <a href="#" class="btn btn-default" role="button"><span class="glyphicon glyphicon-pencil"></span></a>
          <?php endif ?>
